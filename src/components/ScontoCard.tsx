    ...
    <div className="mt-8 rounded-2xl border border-edge-faint bg-surface p-4 shadow-sm shadow-brand-navy/[0.03]">
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 flex-1 items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="text-base font-bold text-brand-teal-ink">Sconto</h3>
      ...
      {scontoAttivo && (
        <div className="mt-4 space-y-3">
          <div className="flex rounded-[10px] border border-edge bg-brand-bg p-0.5">
            <button
              type="button"
          ...
          {valoreNum > 0 && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-bold text-brand-teal-ink">-€{formatImportoEuroVisuale(risparmio)}</span>
            </div>
          )}
        </div>
      )}
