        ...
        <>
          ...
          {!verificato && status === "non_connesso" && (
            <button
              ...
              disabled={aprendo}
              className="mt-4 w-full rounded-lg bg-brand-navy px-4 py-2.5 text-sm font-medium text-white transition hover:bg-brand-navy/90 active:scale-[0.99] disabled:opacity-60"
            >
